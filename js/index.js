app.controller('homeCtrl', ['$scope', '$location', 'ROLES', function ($scope,$location,roles) 
{
	console.log("home");
...
.controller('guestCtrl', ['$scope', '$location', 'ROLES', 'CONFIG', function ($scope,$location,roles,config)
{
